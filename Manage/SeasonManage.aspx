<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Admin.master" AutoEventWireup="true" CodeFile="SeasonManage.aspx.cs" Inherits="Manage_SeasonManage" %>
        ...
        $(document).ready(function () {
         ...
         function getData(p) {
             $.ajax({
                 type: "POST",
                 async: false, //在沒有返回值之前,不會執行下一步動作
                 url: "../handler/getSeasonManageList.aspx",
                 data: {
                     PageNo: p,
                     city: $("#ddlCity").val()
                 },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        <div class="twocol filetitlewrapper">
	        <div class="left"><span class="filetitle font-size5">季報管理</span></div><!-- left -->

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractorList.aspx.cs" Inherits="Manage_ContractorList" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#tablist tbody tr td", function (e) {
                ...
                if ($.getParamValue('tp') == "org")
                    parent.returnPersonValue(jsonval);
                else
                    parent.returnNewPersonValue(jsonval);
        ...
        function getData(p) {
            $.ajax({
                ...
                url: "../handler/getContractorList.ashx",
                data: {
                    CurrentPage: p,
                    SearchStr: $("#SearchStr").val(),
                    City: $.getParamValue('city'),
                    ckNew: $.getParamValue('tp')
                },
                error: function (xhr) {

<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Admin.master" AutoEventWireup="true" CodeFile="Log_ChangeContractor.aspx.cs" Inherits="Manage_Log_ChangeContractor" %>
    ...
    <script type="text/javascript">
        ...
        function getData(p) {
            $.ajax({
                ...
                url: "../handler/getLogChangeContractor.ashx",
                data: {
                    CurrentPage: p,
                    sday: $("#startday").val(),
                    eday: $("#endday").val(),
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        <div class="twocol filetitlewrapper">
	        <div class="left"><span class="filetitle font-size5">承辦人異動紀錄</span></div><!-- left -->
            <div class="right">紀錄查詢 > 承辦人異動紀錄</div><!-- right -->
        </div><!-- twocol -->

<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Admin.master" AutoEventWireup="true" CodeFile="Log_ReportSubDate.aspx.cs" Inherits="Manage_Log_ReportSubDate" %>
    ...
    <script type="text/javascript">
        ...
        function getData(p) {
            $.ajax({
                ...
                url: "../handler/getLogReportSub.ashx",
                data: {
                    CurrentPage: p,
                        ...
                        if (data != null) {
                            ...
                            if ($(data).find("data_item").length > 0) {
                                $(data).find("data_item").each(function (i) {
                                    ...
                                    var tmpType = ($(this).children("L_Type").text().trim() == "04") ? $(this).children("LType").text().trim().substr(0, 2) + "-" + $(this).children("MTpye").text().trim() : $(this).children("LType").text().trim().substr(0, 2);
                                    ...
                                    if ($(this).children("L_Type").text().trim() == "04")
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        <div class="twocol filetitlewrapper">
	        <div class="left"><span class="filetitle font-size5">月 / 季報送審日期</span></div><!-- left -->
            <div class="right">紀錄查詢 > 月 / 季報送審日期</div><!-- right -->
        </div><!-- twocol -->

        <div style="margin-top:10px;">
            <input type="radio" value="" name="MSstatus" checked="checked" />&nbsp;全部&nbsp;
            <input type="radio" value="04" name="MSstatus"/>&nbsp;月報&nbsp;
            <input type="radio" value="05" name="MSstatus" />&nbsp;季報
	    </div>

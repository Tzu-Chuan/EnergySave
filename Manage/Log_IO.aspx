<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Admin.master" AutoEventWireup="true" CodeFile="Log_IO.aspx.cs" Inherits="Manage_Log_IO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("change", "input[name='IOstatus']", function () {
                getData(0);
            });
        });
        ...
        function getData(p) {
            $.ajax({
                ...
                url: "../handler/getLogIO.ashx",
                data: {
                    CurrentPage: p,
                    type: $("input[name='IOstatus']:checked").val(),
                    sday: $("#startday").val(),
                    eday: $("#endday").val(),
                        ...
                        if (data != null) {
                            ...
                            if ($(data).find("data_item").length > 0) {
                                $(data).find("data_item").each(function (i) {
                                    ...
                                    tabstr += '<td align="center" nowrap="nowrap">' + $(this).children("LType").text().trim() + '</td>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        <div class="twocol filetitlewrapper">
	        <div class="left"><span class="filetitle font-size5">登入與登出記錄</span></div><!-- left -->
            <div class="right">紀錄查詢 > 登入與登出記錄</div><!-- right -->
        </div><!-- twocol -->

	    <div style="margin-top:10px;">
            <input type="radio" value="" name="IOstatus" checked="checked" />&nbsp;全部&nbsp;
            <input type="radio" value="01" name="IOstatus"/>&nbsp;登入&nbsp;
            <input type="radio" value="02" name="IOstatus" />&nbsp;登出
	    </div>
        <div style="margin-top:5px;">日期：<input type="text" id="startday" class="inputex" />&nbsp;~&nbsp;<input type="text" id="endday" class="inputex" /></div>
            ...
            <table id="tablist" width="100%" border="0" cellspacing="0" cellpadding="0">
                <thead>
                    <tr>
                        ...
                        <th nowrap="nowrap">身份</th>
                        <th nowrap="nowrap">IP</th>
                        <th nowrap="nowrap">登入/登出</th>

<%@ WebHandler Language="C#" Class="getContractorList" %>

using System;
using System.Web;
using System.Data;

public class getContractorList : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            string ckNew = (context.Request["ckNew"] != null) ? context.Request["ckNew"].ToString() : "";
            ...
            DataSet ds = Member_Db.getContractorList(pageStart.ToString(), pageEnd.ToString(),ckNew);

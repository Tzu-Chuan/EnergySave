<%@ WebHandler Language="C#" Class="saveReportMonthEx" %>
...
public class saveReportMonthEx : IHttpHandler,IRequiresSessionState {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            for (int i=0;i<report_type.Length;i++) {
                ...
                RM_Formula= (context.Request[""+report_type[i]+"RM_Formula"] != null) ? context.Request[""+report_type[i]+"RM_Formula"].ToString() : null;
                ...
                rm._RM_Formula =RM_Formula;
                rm._RM_ReportType = "02"; //01設備汰換 02擴大補助
                //檢查有沒有資料已經存在
            ...
            if (mod_RM_ReportGuid != "")
            {
                ...
                logdb._L_Desc = "修改第" + stage + "期" + year + "-" + month + "擴大補助月報";
            }
            else {
                logdb._L_ModItemGuid = RM_ReportGuid;  //"該月報Guid"
                logdb._L_Desc = "新增第" + stage + "期" + year + "-" + month + "擴大補助月報";
            }

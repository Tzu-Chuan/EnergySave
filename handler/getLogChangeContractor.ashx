<%@ WebHandler Language="C#" Class="getLogChangeContractor" %>

using System;
using System.Web;
using System.Data;

public class getLogChangeContractor : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            DataSet ds = l_db.getChangeContractorList(pageStart.ToString(), pageEnd.ToString(), sday, eday);

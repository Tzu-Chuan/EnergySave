<%@ WebHandler Language="C#" Class="getLogReviewDate" %>

using System;
using System.Web;
using System.Data;

public class getLogReviewDate : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            DataSet ds = l_db.getReviewDateList(pageStart.ToString(), pageEnd.ToString(), sday, eday);

<%@ WebHandler Language="C#" Class="getLogMSModify" %>

using System;
using System.Web;
using System.Data;

public class getLogMSModify : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            DataSet ds = l_db.getMSModifyList(pageStart.ToString(), pageEnd.ToString(), sday, eday);

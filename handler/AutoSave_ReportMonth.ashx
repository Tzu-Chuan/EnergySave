<%@ WebHandler Language="C#" Class="AutoSave_ReportMonth" %>
...
public class AutoSave_ReportMonth : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            context.Response.Write("<script type='text/JavaScript'>parent.autofeedback('Error：" + ex.Message + "')</script>");
        }
    }

...
public partial class handler_ExportTotalBehindByM : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["s"] != null)
        {
            ...
            u_row.CreateCell(1).SetCellValue("年/月");
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (dt.Rows[i]["city_Year"].ToString().Trim() != "" && dt.Rows[i]["city_Month"].ToString().Trim() != "")
                    {
                        //沒有季的資料 畫面就都只SHOW空白
                        u_row.CreateCell(1).SetCellValue(dt.Rows[i]["city_Year"].ToString().Trim() + "/" + dt.Rows[i]["city_Month"].ToString().Trim());
                        u_row.CreateCell(2).SetCellValue(dt.Rows[i]["I_Finish_item1"].ToString().Trim());
                        u_row.CreateCell(3).SetCellValue(dt.Rows[i]["sumC_item1"].ToString().Trim());
                        u_row.CreateCell(4).SetCellValue(dt.Rows[i]["sumF_item1"].ToString().Trim());
                        u_row.CreateCell(5).SetCellValue(dt.Rows[i]["I_Finish_item2"].ToString().Trim());
                        u_row.CreateCell(6).SetCellValue(dt.Rows[i]["sumC_item2"].ToString().Trim());
                        u_row.CreateCell(7).SetCellValue(dt.Rows[i]["sumF_item2"].ToString().Trim());
                        u_row.CreateCell(8).SetCellValue(dt.Rows[i]["I_Finish_item3"].ToString().Trim());
                        u_row.CreateCell(9).SetCellValue(dt.Rows[i]["sumC_item3"].ToString().Trim());
                        u_row.CreateCell(10).SetCellValue(dt.Rows[i]["sumF_item3"].ToString().Trim());
                        u_row.CreateCell(11).SetCellValue(dt.Rows[i]["I_Finish_item4"].ToString().Trim());
                        u_row.CreateCell(12).SetCellValue(dt.Rows[i]["sumC_item4"].ToString().Trim());
                        u_row.CreateCell(13).SetCellValue(dt.Rows[i]["sumF_item4"].ToString().Trim());
                        u_row.CreateCell(14).SetCellValue(dt.Rows[i]["I_Finish_item5"].ToString().Trim());
                        u_row.CreateCell(15).SetCellValue(dt.Rows[i]["sumC_item5"].ToString().Trim());
                        u_row.CreateCell(16).SetCellValue(dt.Rows[i]["sumF_item5"].ToString().Trim());

                        sum01 += (dt.Rows[i]["I_Finish_item1"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["I_Finish_item1"].ToString().Trim());
                        sum02 += (dt.Rows[i]["I_Finish_item2"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["I_Finish_item2"].ToString().Trim());
                        sum03 += (dt.Rows[i]["I_Finish_item3"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["I_Finish_item3"].ToString().Trim());
                        sum04 += (dt.Rows[i]["I_Finish_item4"].ToString().Trim() == "") ? 0 : Convert.ToDouble(dt.Rows[i]["I_Finish_item4"].ToString().Trim());
                        sum05 += (dt.Rows[i]["I_Finish_item5"].ToString().Trim() == "") ? 0 : Convert.ToDouble(dt.Rows[i]["I_Finish_item5"].ToString().Trim());
                        sumC01 += (dt.Rows[i]["sumC_item1"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["sumC_item1"].ToString().Trim());
                        sumC02 += (dt.Rows[i]["sumC_item2"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["sumC_item2"].ToString().Trim());
                        sumC03 += (dt.Rows[i]["sumC_item3"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["sumC_item3"].ToString().Trim());
                        sumC04 += (dt.Rows[i]["sumC_item4"].ToString().Trim() == "") ? 0 : Convert.ToDouble(dt.Rows[i]["sumC_item4"].ToString().Trim());
                        sumC05 += (dt.Rows[i]["sumC_item5"].ToString().Trim() == "") ? 0 : Convert.ToDouble(dt.Rows[i]["sumC_item5"].ToString().Trim());
                        sumF01 += (dt.Rows[i]["sumF_item1"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["sumF_item1"].ToString().Trim());
                        sumF02 += (dt.Rows[i]["sumF_item2"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["sumF_item2"].ToString().Trim());
                        sumF03 += (dt.Rows[i]["sumF_item3"].ToString().Trim() == "") ? 0.0 : Convert.ToDouble(dt.Rows[i]["sumF_item3"].ToString().Trim());
                        sumF04 += (dt.Rows[i]["sumF_item4"].ToString().Trim() == "") ? 0 : Convert.ToDouble(dt.Rows[i]["sumF_item4"].ToString().Trim());
                        sumF05 += (dt.Rows[i]["sumF_item5"].ToString().Trim() == "") ? 0 : Convert.ToDouble(dt.Rows[i]["sumF_item5"].ToString().Trim());
                    }
                    else {
                    ...
                    u_sheet.GetRow(i + 2).GetCell(2).CellStyle = cs_right;
                    ...
                    u_sheet.GetRow(i + 2).GetCell(8).CellStyle = cs_right;
                    u_sheet.GetRow(i + 2).GetCell(9).CellStyle = cs_right;
                    u_sheet.GetRow(i + 2).GetCell(10).CellStyle = cs_right;
                    u_sheet.GetRow(i + 2).GetCell(11).CellStyle = cs_right;
                    u_sheet.GetRow(i + 2).GetCell(12).CellStyle = cs_right;
                    u_sheet.GetRow(i + 2).GetCell(13).CellStyle = cs_right;
                    u_sheet.GetRow(i + 2).GetCell(14).CellStyle = cs_right;
                    u_sheet.GetRow(i + 2).GetCell(15).CellStyle = cs_right;
                    u_sheet.GetRow(i + 2).GetCell(16).CellStyle = cs_right;

                    //最後一筆要合計
                    if (i == dt.Rows.Count - 1)
                    {
                        u_row = u_sheet.CreateRow(i + 3);
                        ...
                        //指定欄位style
                        u_sheet.GetRow(i + 3).GetCell(0).CellStyle = cs_center;
                        u_sheet.GetRow(i + 3).GetCell(1).CellStyle = cs_center;
                        u_sheet.GetRow(i + 3).GetCell(2).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(3).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(4).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(5).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(6).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(7).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(8).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(9).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(10).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(11).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(12).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(13).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(14).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(15).CellStyle = cs_right;
                        u_sheet.GetRow(i + 3).GetCell(16).CellStyle = cs_right;
                    }
                }
            }
            //******************* 內容 end *******************//
            ...
            workbook.Write(ms);
            string fileName = "各縣市申請數(月累計)" + strStage + "期" + DateTime.Now.ToString("yyyyMMddHHmmss");

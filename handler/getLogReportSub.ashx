<%@ WebHandler Language="C#" Class="getLogReportSub" %>

using System;
using System.Web;
using System.Data;

public class getLogReportSub : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
            ...
            DataSet ds = l_db.getReportSubList(pageStart.ToString(), pageEnd.ToString(), sday, eday);

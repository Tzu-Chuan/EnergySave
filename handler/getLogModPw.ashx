<%@ WebHandler Language="C#" Class="getLogModPw" %>

using System;
using System.Web;
using System.Data;

public class getLogModPw : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
          try
        {
            ...
            DataSet ds = l_db.getLogModPwList(pageStart.ToString(), pageEnd.ToString(), sday, eday);
